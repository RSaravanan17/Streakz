...
class StreakPostScreenViewController: UIViewController {
    ...
    @IBOutlet weak var streakPostDescription: UILabel!
    ...
    override func viewDidLoad() {
        ...
        self.streakPostDescription.numberOfLines = 0
        ...
        self.streakPostDescription.text = self.streakPostDelegate.currentStreakPost!.postText
